...
public class TestaCaixa {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * Caixa<Integer> caixaDeIdade = new Caixa(); caixaDeIdade.setConteudo(30);
		 * System.out.println(caixaDeIdade.somaConteudoNaCaixa(26));
		 * 
		 * Caixa<Double> caixaDeValor = new Caixa<>(); caixaDeValor.setConteudo(150.50);
	...
	public <T> T somaConteudoNaCaixa(T valor) {
		 ...
		 * Integer resultado = c + i; return (T) resultado; } else if (this.conteudo
		 * instanceof Double c && valor instanceof Double d) { Double resultado = c + d;
		 * return (T) resultado; } else if (this.conteudo instanceof String c && valor
		 * instanceof String s) { String resultado = c + "\n" + s; return (T) resultado;
		 * }
		 * 
		 * return null;
		 */
